...
contract TestPrivacyPool is Test {
    ...
    function convertCipherText(string[][] memory cipherText) public returns (uint256[4][] memory) {
        uint256[4][] memory cipherNumbers = new uint256[4][](4);
    ...
    function testProcess() public {
        ...
        // TODO - make this a uint256[4][2] so it can be passed to the supplement function 
        uint256[4][] memory ciphertexts = convertCipherText(ciphertexts_string);
